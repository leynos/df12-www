...
possible violation, contact the project maintainers at
[conduct@df12.studio](mailto:conduct@df12.studio).
...
In order to honour these values, enforcement actions are carried out in private
...
2. Consequence: Access to all community spaces, tools, and communication
   ...
   working through other remedies has failed to change the behaviour.
...
licensed under
[the Contributor Covenant licence](https://github.com/EthicalSource/contributor_covenant/blob/release/LICENSE.md).

Original text is Copyright 2025 Organization for Ethical Source.
