...
const { createIndexCache, siteRootFromIndexPath } = require(
    "../../public/netsuke/assets/js/doc-search.js"
);
...
describe("siteRootFromIndexPath", () => {
    test("derives the sub-site root from the index path", () => {
        expect(
            siteRootFromIndexPath("/netsuke/assets/search/docs-search.json")
        ).toBe("/netsuke/");
    });
