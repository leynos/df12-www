...
(() => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    var buttons = Array.from(document.querySelectorAll<HTMLButtonElement>("button[data-category]"));
    var articles = Array.from(document.querySelectorAll<HTMLElement>("article[data-category]"));
    ...
    function applyFilter(category: string | undefined): void {
      buttons.forEach((btn) => {
