...
/* stylelint-disable -- Generated by scripts/generate_episodic_pygments_css.py;
   the token rules are emitted one per line, and a lint finding here is a
   change to the generator, not to this file. */
"""
